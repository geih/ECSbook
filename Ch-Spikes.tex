...
Also, the shape of the spike is very different from the shape of intracellularly recorded action potentials (Fig.~\Fref{fig:Spikes:Henze}).
...
strongly depending on the position at which it is recorded.  This is illustrated in Fig.~\Fref{fig:Spikes:MultiCompartment} showing computed spikes at various 
...
in Fig.~\Fref{fig:Spikes:MultiCompartment} be explained by simpler neuron models? 
...
in any way.  As discussed in Sec.\Fref{sec:VC:electrodes}, however, real recording devices will in general affect
...
is provided by Fig.~\Fref{fig:Spikes:electrode_size}) showing spikes recorded with circular electrodes of different radii.
...
Figure~\Fref{fig:Spikes:MEA-setup}.
...
An example result is shown in Figure~\Fref{fig:Spikes:MEA-spikes}.
