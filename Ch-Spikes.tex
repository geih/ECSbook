...
%%%
\gen{Si noe om maalet om aa forstaa multicomp spikes, approksimative modeller}
...
Figure~\ref{fig:Spikes:DifferentNeuronModels}A. Around the soma, characteristic
...
\begin{itemize}
\item Compare with multicompartmental model results in Figure~\ref{fig:Spikes:DifferentNeuronModels}(left)
