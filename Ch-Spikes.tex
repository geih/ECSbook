...
\begin{itemize}
\item Focus above on spikes from somas
\item Also spikes from axons
\item Why small spike from active cable
\begin{itemize}
\item Thin axons have small surface area compared to soma
\item Triphasic - form of action potential on cable  \cite**{Plonsey1977}, \cite**[Ch. 8]{Plonsey2007}
\end{itemize} 
\item But larger effects can be seen around axonal terminations
\item Go through figure from \cite**{McColgan2017}
\end{itemize}
