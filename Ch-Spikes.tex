...
\section{\red{Effects of measurement device on spike recordings}}
...
by averaging results from using the point approximation across the surface of the electrode. An example of its 
...
\subsection{\red{Microelectrode arrays (MEAs)}}
