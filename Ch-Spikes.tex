...
spike recordings as exemplified in Figure~\ref{fig:Spikes:Henze}. The same spikes with inverted form are observed outside
...
A prediction from the near-field formula in Equation~\ref{Spikes:equation:Ve_near_2} is that the amplitude of each Fourier component decays as $1/r$ when moving away from the soma, 
