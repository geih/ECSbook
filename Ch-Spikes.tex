...
\begin{figure}[!ht]
\begin{center}
\includegraphics[width=0.8\textwidth]{Figures/Spikes/Spikes-fig_hay_eap_simpler}
\end{center}
...
for neurons with passive dendrites: (i) the spike width was seen increase with distance from the soma (cf.~Fig.~5A in Ref.~\cite**{Gold2006}), (ii) the spike amplitude was seen to decay with distance from the soma with a power between 1 and 2 for distances less than 50 $\mu$m (cf.~Fig.~14 in Ref.~\cite**{Gold2006}), and (iii) the spike amplitude was also seen to change significantly to varying intracellular resistivity $R_i$ and capacitance $C_m$, but not so much to varying membrane resistivity \cite**{Gold2007}. They also found that extracellular waveforms provide tight constraints on some of the neuronal model parameters, suggesting that extracellular spikes could be useful for constraining compartmental models \cite**{Gold2007}.
...
\section{\red{Effects of size of recording electrode on spike shape}}




\begin{itemize}
\item Until now: point-electrode approximation
\item Modeling electrode-size effect with disc-electrode approximation (Fig.~\ref{Spikes:fig:electrode_size}),
Sec.\ref{VC:sec:disc-electrode}
\item Spikes in MEA
\begin{itemize}
\item Vise formel for "Method of images"?
\item Kanskje egen section?
\end{itemize}
\end{itemize}
...
\section{\red{Multi-unit activitiy}}

\begin{itemize}
\item \cite{Pettersen2008}
\item New figure showing cancellation
\end{itemize} 
