...
is shown in panel (a) in Figure~\ref{LFP:fig:LFP-how-local}.
...
Olbers' paradox and the link to the spatial-reach question is described in Box~\ref{LFP:box:Olbers}.


\subsubsection{\gex{Box:  Why is the night sky dark? Olbers' paradox}}
...
%%%%%%%%%%
\subsubsection{\gex{Box: General expression for population LFP}}
