...
\item The fundamental equation of the HHC formalism (eq. \ref{Neuron:eq:multimain}) was derived under the assumption that the extracellular potential ($\phi_e$) is zero. Although this is not true, $\phi_e$ is generally much smaller than the membrane potential $\phi_m$. The (ephaptic) effect \index{Ephaptic effects} that $\phi_e$ has on neurodynamics is therefore small \cite{anastassiou2015}, and in the HHC formalism it is neglected.
