...
\subsection{\ehtxt{Axial and transmembrane currents}}

\ehnote{Siden denne boken bygger opp til ekstracellulaere maalinger av aktivitet, er det litt snaalt aa ikke legge til noe om analytiske relasjoner for aksiale og transmembrane stroemmer her fra Pettersen2014 for eksempel:}

\begin{eqnarray}
I_i(x,t) &=& - \frac{1}{r_i} \frac{\partial V(x,t)}{\partial x} \\
i_m(x, t) &=& - \frac{\partial I_i (x, t)}{\partial x} = \frac{1}{r_i} \frac{\partial^2 V(x,t)}{\partial x^2}
\end{eqnarray}
