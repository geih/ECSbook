...
The LFP is thought to reflect synaptic inputs to thousands of pyramidal neurons, but many important features of the LFP can be studied by considering synaptic input to single neurons.

\subsection{Intrinsic dendritic filtering}
For high frequencies, the membrane is more leaky, and current returns closer to the input \ref{LFP:fig:intrinsic_dendritic_filt}.

\begin{figure}[!ht]
\begin{center}
\includegraphics[width=.8\textwidth]{Figures/LFP/intrinsic_dend_filt.pdf}
\end{center}
