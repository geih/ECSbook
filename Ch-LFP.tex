...
\subsection{\orange{Example: How local is the  local field potential? - GTE}}
...
\subsubsection{\orange{Qualitative model}}
...
\subsubsection{\red{Box:  Why is the night sky dark? Olbers' paradox}}
...
\subsubsection{\orange{Quantitative model}}
...
%%%%%%%%%%
\subsubsection{\red{Box: General expression for population LFP}}
...
\subsubsection{\orange{How sharply does the LFP decay outside a population of neurons?}}
