\chapter{Local Field Potentials: Synaptic contributions}
\label{chap:LFP}
\ghnote{Skifta tittel. La til "Synaptic contributions". Her blir det viktig aa faa framat LFP er definert som det vi maaler ekstracellulaert inni hjernen med en oevre cut-off paa 300 eller 500 Hz. Sa kan vi si at dette primaert reflekterer synaptisk input, men at det kan kludres til av andre saker. Vi faar avgjoere om vi skal diskutere de andre sakene her, eller i neste kapittel.
"Synaptisk" inneholder jo baade synapsestroemmer, passive returstroemmer, kapasitive returstroemmer, og eventuelle aktive returstroemmer. Det finnes vel ingen klar grense mellom hva som er "passive" eller "kvasipassive" og hva som er aktive, og Ca-spikes er vel muligens en sann ting som kludrer det til? }
...
\section{\orange{LFP from single postsynaptic neuron}}

\begin{itemize}
\item The "building block" of LFPs
\end{itemize}

\subsection{\red{The dipolar nature of LFP signals}}
...
\subsection{\red{Strong LFP signals require asymmetry}}
...
\subsection{\red{Morphology matters}}
...
\subsection{\red{Distance-decay LFP signals from different origins}}
...
\subsection{\red{Effect of subthreshold active conductances}}
...
\section{\orange{LFP from single presynaptic neuron}}

\subsection{\red{Unitary LFPs (and the kernel method)}}
\index{Unitary LFP}

\begin{itemize}
\item Add "thalamic" unitary LFP \cite**{Hagen2017}
\end{itemize}
...
\section{\orange{LFP from neural populations}}
...
\subsection{\red{Analytical formulas for population LFPs}}

\subsection{\red{Effect of synaptic correlations}}
...
\section{\orange{Example: How local is the  local field potential?}}
...
\subsection{\orange{Qualitative model}}
...
\subsection{\red{Box:  Why is the night sky dark? Olbers' paradox}}
...
\subsection{\orange{  Quantitative model}}
...
\gen{  Note that the boost of LFPs requires asymmetric input.}
...
%%%%%%%%%%
\subsection{\red{  Box: General expression for population LFP}}
...
\subsection{\orange{  How sharply does the LFP decay outside a population of neurons?}}
...
\section{\red{  Insights from LFP studies}} 

\subsection{\red{Network LFPs}}
...
\subsection{\red{Approximate schemes}}
...
\subsection{\red{Population LFPs}}
\begin{itemize}
\item Full simulations \cite**{Linden2011,Leski2013}
\item Analytical results \cite**{Einevoll2013a}
\item Active dendrites \cite**{Ness2018}
...
\section{\orange{LFPs from other sources}}

\subsection{\red{Effect of spikes on the LFP}}
...
\subsection{\red{Validation of framework}}
...
\section{\orange{Analysis of LFPs (?)}}

\subsection{\red{Current Source Density (CSD) analysis}}
