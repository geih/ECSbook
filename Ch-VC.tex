...
Here, $\sigma_\text{t}$ has the interpretation of a macroscopic tissue conductivity as we have defined it previously, 
while ${\bf i}_\mathrm{p}$ is referred to as the \textit{primary current density}\index{Primary current}, 
which incorporates both ${\bf i}_\mathrm{i}$ and the above mentioned
