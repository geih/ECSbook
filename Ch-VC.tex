...
Large multi-contact electrode shanks can be expected to have a substantial effect on close-by extracellular potentials, since they represent large, non-conducting volumes \cite**{Moffitt2005,Lempka2011,Mechler2012,Buccino2019}. It has been demonstrated that such large probes can amplify or dampen recorded potentials from nearby cells by almost a factor of two, depending on whether the cell was in front of or behind the electrode shank \cite**{Moffitt2005,Buccino2019}, while no such effects were found for small microwires \cite**{Buccino2019}.
\tvntxt{Note that efforts to model large non-conducting volumes such as this are also briefly covered in \fref{sec:Sigma:nonhomo}.}
...
the reference electrode should be sufficiently far away that it is not itself affected
