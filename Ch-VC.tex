...
electrode impedance or other electrode properties should not substantially distort recorded potentials. In other words, it is assumed that the recorded potential, $V_{Rec}$ is identical to the average potential across the electrode surface, which we will here refer to as $V_{True}$ 
...
\tvnnote{Dette er jeg ikke ferdig med!}
\ghtxt{
