...
\label{VC:fig:CSD}
\end{figure}
\snnote{Use C, not CSD, as in definition above?}
...
\tvnnote{Også ta med uttrykket med integrasjon, slik som i lign. (4) i Linden et al. (2014)?}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{\blue{Infinite anisotropic homogeneous extracellular medium}}
\label{sec:anisohomo}
\tvnnote{Blir det feil å bare kalle seksjonen "Anisotropic extracellular medium"? Syntes det blir litt rotete å ta med "infinite" og "homogeneous" i tittelen.}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{\blue{Nonhomogeneous extracellular medium}}
\label{sec:nonhomo}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{\orange{Dipole approximation}}
\label{sec:dipole}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{\orange{Approximations used in VC theory}}
\label{sec:approximations}
\ghnote{Maybe some of this should be moved to chapter about sigma}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\subsubsection{\orange{Quasi-static approximation of Maxwell's equations}}
...
\subsubsection{\orange{Linear extracellular medium} }
...
\subsubsection{\orange{Extracellular currents are exclusively due to Ohmic drift}}
\label{sec:onlyohmic}
...
\subsubsection{\orange{No ephaptic coupling} }
