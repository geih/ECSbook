...
\end{center}
\caption[]{\textbf{Point- versus line-source approximation.} \ghn{Very nice, but I suppose we need to write some words about these simulations, use of neuron model etc?}
}
...
\end{center}
\caption[]{\textbf{Effect of electrode size.}Bigger recording electrodes can cause smaller and broader EAPs.  \ghn{Flott. Kursivere $r$? Forklare simuleringen?}}
