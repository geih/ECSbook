...
\gen{Kanskje det kunne være en ide å også beskrive methods-of-imaging og modellering i MEAs her?
Hadde først tenkt å ta det med i Spikes-kapitlet. Men den gjelder jo like mye for LFP og har blitt brukt av oss i denne 
sammenheng i flere prosjekter med  Ness eller Pettersen som førsteforfatter.}
...
\end{equation}
\gen{Synes ikke "superscripts" eller "subscripts" skal være bold}
