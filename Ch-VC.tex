...
\gen{Hvorfor itot og ikke it som over?} 
...
\gen{"coarse-grained" har blitt brukt tidligere ...} 
...
over the cellular domain (i.e., the first term on the right \gen{left?} in \fref{eq:Basics:Sergey3}) 
can be expressed as a sum of transmembrane currents, 
i.e., as a current source density ($C$), like in \fref{eq:VC:CSD1}. 
