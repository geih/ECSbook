...
their contributions add up linearly \tvntxt{(see assumptions at the start of this chapter)}, 
and the potential in a point ${\bf r}$ is given by:
...
A more rigorous derivation of it was given by \citeasnoun**{Gratiy2017}. 
...
This equation is valid at the spatial scale sufficiently coarse-grained for it to be meaningful 
to operate with continuous variables such as currents (cf. \fref{sec:Basics:scale_jump1}), 
while still sufficiently small for the currents to be defined meaningfully as either 
intracellular, extracellular or transmembrane currents. 
\tvnnote{Dette syntes jeg ble litt uklart. Kan vi kanskje si at volumet vi tenker paa enten er intracellulaert, extracellulaert eller at det gaar over membranen?}.
...
\ghnote{Fremdeles ikke 100 prosent i maal her. Sergey skriver ikke noe om hvor grensa gaar, men bare at the surface bounding the volume is the cellular membrane. Tobjorn - hadde du en ref der Sergey saa paa effekter av aa legge grensa andre steder?}. 
\tvnnote{Ikke sikker, men refererte kanskje til denne: Gratiy, Pettersen, Einevoll, Dale (2013) Pitfalls in the interpretation of multielectrode data: on the infeasibility of the neuronal current-source monopoles. J Neurophysiol 109:1681–1682.}. With this, \fref{eq:Basics:Sergey2} 
With this, \fref{eq:Basics:Sergey2} becomes: 
...
Related to this, $\sigma_\text{t}$ in \fref{eq:VC:CSD3} denotes the average conductivity 
