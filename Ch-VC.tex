...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{\orange{SOLVEIG: Dipole approximation}}
\label{sec:dipole}
\ghnote{GH: Jeg skrev en skisse til dette kapittelet, men fint om Solveig kan gaa gjennom.}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\subsection{\red{TORBJORN: Electrodes}}
\label{sec:electrode}
\begin{itemize}
