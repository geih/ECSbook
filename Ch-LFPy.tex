...
As we shall demonstrate here, certain proxies can still provide excellent insight into the temporal properties of extracellular signals of neural activity.
...
As $R^2$ is defined as the squared correlation coefficient, $R^2 \lesssim 1$ imply a near linear dependence between the proxy and actual signal while $R^2 \gtrsim 0$ imply independence.
...
its performance is indeed better as the membrane voltages indeed reflect transmembrane currents but do not equate them. 
