...
\ehnote{placeholder -- maa gaa over XY notasjon med lupe}
}
...
\ehnote{kommer til aa splitte i to figurer for hybrid of kernerprediksjoner}
}
...
Legg til labels! Current dipole moments?} 
}
\label{fig:g_proxy}
\end{figure}
