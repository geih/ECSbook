...
\sntxt{Using the Biot-Savart law, we can compute the magnetic field outside of neurons by summing up the contributions from the set of axial currents \cite**{Blagoev2007,Hagen2018}:} 
%
\begin{equation}
