...
One could even do single-cell simulations serially. 
...
Ignoring other conductances which may be present (active ion channels etc.), 
the total membrane conductance per postsynaptic compartment $w$ is
\begin{equation}
G_{\mathrm{tot}}(t) = G_L + \sum_X \sum_{u \subset X} \overline{G}_{\mathrm{syn}YX} \left( f_{YX} \ast s_u \ast \Delta_{YX} \right)(t)
\end{equation}
...
and $\Delta_{YX}(t)$ the conduction delay distribution. 
...
Here, extracellular potentials predicted from a multicompartment neuron network model (left) is compared to predictions made using the hybrid scheme 
with either passive or quasi-linear predictors, 
as well as kernel-based approximations.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             
}
...
their covariance normalized by ground truth signal variance ($COV(\hat{\phi}, \phi)/VAR(\phi)$).
}
