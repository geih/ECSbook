...
\item Let $\mathbf{r}_i \in \Omega_X$ denote the discrete somatic location of neuron $i$ in a spatial domain $\Omega_X$
...
\item The conduction delay from presynaptic action potential generation time  to activation time of the synapse $d_{YX}$ be constant (i.e., independent of cell location and geometry). 
\end{enumerate}
