...
\ehnote{har latt teksten i dette delkapitlet vaere. Dette flyttes tilbake igjen til slutten eller helt ut av kapitlet.}
...
$\phi$ \ehnote{Jeg vil bruke $\phi$ som generisk signal symbol for $V_e$, $P$, $B$ osv. OK?} 
...
The I cells have a prominent apical section \SI{1}{\milli\metre} in length while the I cells are symmetric around the soma. 
