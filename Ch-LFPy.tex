...
Visually, accounting for the effective membrane leak conductance allows for predictions that accurately capture the ground-truth signal in terms of spatiotemporal properties and also signal amplitudes across depth. 
Signal amplitudes are otherwise overestimated in a non-trivial manner, even if the spatiotemporal pattern of the signals are well preserved. 
}
