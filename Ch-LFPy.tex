...
When aiming to make \ehtxt{biphysically detailed \sout{realistic}} simulations of extracellular potentials, one might need to simulate large networks containing thousands of neurons. This is computationally demanding, even on an efficient scheme like MC+VC.
...
\ehnote{placeholder - tenker fjerne current dipole moment. EI og IE subfix er bytta om, skal fikses.}
}
