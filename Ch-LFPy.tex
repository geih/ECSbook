...
For compactness, we choose a symbolic notation wherever possible as we will reuse these symbols later. 
Their particular values are summarized in \ehnote{legg/ref til tabell med verdier}.
Then:
