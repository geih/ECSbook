...
For now, we will emphasize that typical measures of extracellular electric or even magnetic signals can be derived from the transmembrane currents alone.
...
\ehtxt{While we will summarize results of these simplifying steps quantitatively towards the end of this Chapter, 
...
\end{center}
\caption{\textbf{Ground truth signals vs. kernel-based approximations.}
