...
\section{\red{Population firing rate models}}
...
is how the hybrid forward modeling scheme and the above `kernel trick' may be adapted for use with population rate models. 
