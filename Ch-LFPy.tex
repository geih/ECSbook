...
\hline
$L_\text{soma}, L_\text{apic}, L_\text{basal} $ & \(\displaystyle \begin{cases} &\{30, 1000, 200\}~\si{\micro\metre}~\text{for}~X=E \\ &\{30, 1000, 200\}~\si{\micro\metre}~\text{for}~X=I \end{cases} \)  & Section length \\
$d_\text{soma}, d_\text{apic}, d_\text{basal} $ & \(\displaystyle \begin{cases} &\{30, 3, 2\}~\si{\micro\metre}~\text{for}~X=E \\ &\{15, 2, 2\}~\si{\micro\metre}~\text{for}~X=I \end{cases} \)  & Section diameter \\
$n^\text{seg}_\text{soma}, n^\text{seg}_\text{apic}, n^\text{seg}_\text{basal} $ & \(\displaystyle \begin{cases} &\{1, 21, 5\}~\text{for}~X=E \\ & \{1, 5, 5\} ~\text{for}~X=I  \end{cases} \) & \# segments per section \\
...
$\overline{g}_\mathrm{Na}$ & 0.12, 0.012, 0.012 \si{\siemens\per\square\centi\metre}& Na$^+$  conductance \\
$E_\text{Na}$ & \SI{50}{\milli\volt} & Na$^+$ reversal potential \\
$\overline{g}_\mathrm{K}$ & 0.036, 0.0036, 0.0036 \si{\siemens\per\square\centi\metre} & K$^+$ conductance  \\
$E_\text{K}$ & \SI{-77}{\milli\volt} & K$^+$ reversal potential \\
$\overline{g}_\mathrm{Ih}$ & 0.002, 0.01, 0.01 \si{\siemens\per\square\centi\metre} & Ih-current conductance \\
\hline
