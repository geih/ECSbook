...
including irregular firing patterns \ehtxt{\cite**{Softky1993,van_Vreeswijk1997,Amit1997,Shadlen1998}, 
...
One key feature of the this hybrid scheme application as devised by \cite**{Hagen2016} was an assumed-to-be \emph{linear} spike-LFP relationship, that is, 
...
at this point could destroy every connection of the recurrently connected network \ehtxt{in panel A},
...
However, \cite**{Hagen2016} also showed that population averaged spike-LFP impulse responses can be used to accurately reconstruct the LFP signal, 
...
such as the current dipole moment (and measures that can be computed from it). 
}
