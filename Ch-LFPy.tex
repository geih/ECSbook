...
=
\begin{pmatrix}
I_\mathrm{a}(\mathbf{r}_1, t) (\mathbf{r}_{\mathrm{f}1} - \mathbf{r}_{\mathrm{i}1}) / || \mathbf{r}_{\mathrm{f}1} - \mathbf{r}_{\mathrm{i}1} || \\
I_\mathrm{a}(\mathbf{r}_2, t) (\mathbf{r}_{\mathrm{f}2} - \mathbf{r}_{\mathrm{i}2}) / || \mathbf{r}_{\mathrm{f}2} - \mathbf{r}_{\mathrm{i}2} || \\
\vdots \\
I_\mathrm{a}(\mathbf{r}_N, t) (\mathbf{r}_{\mathrm{f}N} - \mathbf{r}_{\mathrm{i}N}) / || \mathbf{r}_{\mathrm{f}N} - \mathbf{r}_{\mathrm{i}N} ||
\end{pmatrix} ~,
\end{equation}
%
