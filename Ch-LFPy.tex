...
these models generally takes the form of a linear combination
\begin{equation}
...
one can with relative ease estimate a linear predictor from transmembrane currents by applying a similar trick as above: 
