...
An important question for interpreting and modelling electric signals in neuroscience is whether the conductivity of neural tissue is frequency-dependent. 

This would not in itself be surprising: Tightly packed with neurons, and because of the capacitive properties of the membrane, the electrical properties of membranes are highly frequency dependent. Extracellular currents could make use of the capacitive properties of membranes to move through them, and if so, this would increase the conductivity for higher frequencies.
