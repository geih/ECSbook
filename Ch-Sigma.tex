...
\tvntxt{the apparent spatial stability of LFP signals relative to spike recordings, as well as an explaination of why the LFP and EEG signal is so biased towards low frequencies \cite**{Bedard2004}.} %and 1/f power-laws in LFP \tvnnote{Expand a little on this and cite the French}. \ghnote{Forsto ikke helt setningen, men antar, som du antyder, at den er uferdig.}
