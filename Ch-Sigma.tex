...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
In Chapter \ref{sec:VC}, we assumed that the tissue conductivity $\sigma_t$ was isotropic, i.e., the same in all spatial directions. 
...
However, the overall effect of the anisotropy on extracellular potentials, at least in cortex, often appears to be quite weak \cite**{Ness2015,Miceli2017}, and the approximation that $\sigma_t$ is isotropic often gives good predictions of the potential. See Figure~\ref{Sigma:fig:anisotropy_effect} for an example where a 50\% increase in the conductivity along the axis of the apical dendrite, only causes a slighty more squeezed shape of the extracellular potential than the isotropic case.
