...
(in which case it would be called the impedance spectrum \gen{Upresis formulering}). 
If it does, extracellular potentials will be distorted \tvntxt{\sout{as they propagate through}by} the tissue, 
...
\gen{Kanskje si at dette tricket soerger for riktige grensebetingelser (og fortelle hva disse er) paa grenseflaten?}
