...
$\sigma_\text{t}$ range from 0.03 -- 0.4 \si{S/m} \cite*{Martinsen2008}
$\sigma_\text{t} = 0.47 \pm 0.24 \, \si{S/m}$ \cite*{mccann2019}
$\sigma_\text{t}$ ranges from 0.03 to 0.7 \si{S/m} \cite*{Miceli2017}
$= 0.47 \pm 0.24 \, \si{S/m}$ \cite*{mccann2019}



\ghnote{Hva er en bra range aa angi her? Micelifiguren oppsummerer studier som har sett paa f-avhengighet, men det finnes vel i tillegg mange maalinger som ikke har den ambisjonen. I Oerjanboka staar det at $\sigma$ for grey matter er 0.03 -- 0.4 S/m i omraadet 1 Hz til 10 kHz. McCann 2019 oppsummerer et sammensurium av ulike maaleteknikker. Det vi er interessert i er nok det de der kaller Directly Applied Current, som er den mest invasive metoden. Uansett lander McCann paa $0.47 \pm 0.24 \,\si{S/m}$, som da lander paa mye hoeyere verdier enn Oerjan. }
...
which typically range between 1.3 and 1.8~\si{S/m}\cite**{Okada1994,Baumann1997,Logothetis2007,Martinsen2008,Miceli2017}.
